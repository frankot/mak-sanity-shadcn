...
const stats = [
  ...
  { label: "O trudnościach od 4 do 8a", value: "200 dróg" },
];
  ...
  return (
    <main className="isolate ">
      <div className="relative isolate -z-10">
        <svg
          className="absolute inset-x-0 top-0 -z-10 h-[200vh] w-full stroke-gray-200 [mask-image:radial-gradient(62rem_77rem_at_center,white,transparent)]"
          aria-hidden="true"
        >
          <defs>
            <pattern
        ...
        >
          <div
            className="aspect-[801/1036] w-[50.0625rem] bg-gradient-to-tr from-[#ff80b5] to-orange-600 opacity-50"
            style={{
              clipPath:
              ...
              <div className="mt-14 flex justify-end gap-8 sm:-mt-44 sm:justify-start sm:pl-20 lg:mt-0 lg:pl-0">
                <div className="ml-auto w-44 flex-none space-y-8 pt-32 sm:ml-0 sm:pt-80 lg:order-last lg:pt-36 xl:order-none xl:pt-80">
                  <div className="relative">
                    <img
                      src="https://arenamakak.pl/web/pageFiles/static/7/makak-001-sierpnia-04-2021_700x500.jpg"
                      alt=""
                ...
                <div className="mr-auto w-44 flex-none space-y-8 sm:mr-0 sm:pt-52 lg:pt-36">
                  <div className="relative">
                    <img
                      src="https://arenamakak.pl/web/pageFiles/news/177/71e0bd71-42b8-4972-97b0-416da4479891_590x2000.JPG"
                      alt=""
                      className="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                    />
                    <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
                  ...
                  <div className="relative">
                    <img
                      src="https://arenamakak.pl/web/pageFiles/static/22/makak-5-urodziny-097-listopada-30-2019_700x500.jpg"
                      alt=""
                      className="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                    />
                    <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
                ...
                <div className="w-44 flex-none space-y-8 pt-32 sm:pt-0">
                  <div className="relative">
                    <img
                      src="https://arenamakak.pl/web/pageFiles/static/26/makak-5-urodziny-074-listopada-30-2019_700x500.jpg"
                      alt=""
                      className="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                    />
                    <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
                  ...
                  <div className="relative">
                    <img
                      src="https://arenamakak.pl/web/pageFiles/static/27/makak-szeroko-z-gry-036-padziernika-03-2019_700x500.jpg"
                      alt=""
                      className="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
                    />
                    <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
